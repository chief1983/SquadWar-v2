				...
				<?php else: ?>
					...
					<div class="copy">
						<form action="_join_squad.php" method="post" name="login" class="validate">
							...
							<b>PXO Login:</b><br />
							<input type="text" name="pxo_login" value="<?php echo $_SESSION['login']; ?>" title="You must enter your PXO login." class="required" size="20" maxlength="50" /><br />
							<b>PXO Password:</b><br />
							<input type="password" name="pxo_password" value="" title="You must enter your PXO password." class="required password" size="20" maxlength="50" /><br />
							<br />
