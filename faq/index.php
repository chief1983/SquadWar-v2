...
?>
				...
				<div class="copy">
						...
						<br />
						<div class="answer">
						<b>A:</b> Leagues are individual "games" of SquadWar.  Think of a SquadWar League as something similar to a bowling league, basketball season, or club event.  Your team can participate in multiple Leagues at the same time.  The individual League maps don't exist within the rules of the FreeSpace universe.  The current FreeSpace node map is way too limiting to create a single league, much less multiple leagues.  A SquadWar league map needs at least three node connections from every system other than an entry node in order to provide the most amount of fun and ease of territorial expansion.
						</div>
						...
						<br />
						<div class="answer">
						<b>A:</b> Click on the action "Admin Squad" once you have logged in to the SquadWar site.  Log into your Squad and you will be given the option to sign up for a league.  You must have two members on your active roster before joining a league.
						</div>
						...
						<div class="question">
						<b>Q:</b> Our SquadWar match ended, we didn't receive notification that stats had updated, but everything updated properly, what happened?
						</div>
						<br />
						<div class="answer">
