...
{
	$info->set_swsquad1_protest(1);
	$info->set_swsquad1_protest_datetime(date('Y-m-d H:i:s'));
}
if($match->get_SWSquad2() == $_SESSION['squadid'])
{
	$info->set_swsquad2_protest(1);
	$info->set_swsquad2_protest_datetime(date('Y-m-d H:i:s'));
}
$status = $info->save();
