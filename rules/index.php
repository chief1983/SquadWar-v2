...
?>
				...
				<div class="copy">
						...
						*/ ?>
						...
						<b>Deactivation</b>
						<ul>
						<li>If a team fails to participate in any matches for a period of two weeks, they are placed on an administrative list and are considered for deactivation.</li>
						<li>The Squad War administrator will contact squadrons pending deactivation.  Failure to respond within 48 hours will result in deactivation.</li>
						<li>Deactivated squadrons or squadrons who drop out of Squad War forfeit all of their sectors.  The sectors become uncontrolled and all pending matches are removed.  All contesting squadrons having pending matches with the removed squadron are notified via email.</li>
						</ul>
						...
						<ul>
						<li>Two squadrons can vie for control over an adjacent, unclaimed region of space.  If a sector of space is uncontrolled, one team may challenge another team adjacent to that sector for control of said sector.</li>
						<li>If a sector is controlled, a squadron in an adjacent sector can pose a challenge to the controlling owner of that sector.</li>
						<li>A squadron may only issue two outstanding challenges, each unique:
						<ol>
						<li>A squadron may only issue one challenge at a time for controlled territory.</li>
						<li>A squadron may only issue one challenge at a time for uncontrolled territory.</li>
						</ol>
						</li>
						<li>A squadron may have multiple outstanding challenges.  The number of outstanding challenges will be within a set limit. The current limit for this league is 10.</li>
						<li>The challenge squad has 24 hours from the time the challenge is created to proprose two dates/times for the match to take place.</li>
						<li>(to be implemented at a later date) A team has 48 hours to respond to challenge.  The challenger has 48 hours to finalize the challenge after the challenged squadron responds.</li>
						<li>(to be implemented at a later date) A challenge must be scheduled to occur within eight days of the initial challenge, limited to days six through eight. Unless both teams agree to a shortened time period.  Both teams should still use the scheduling system to avoid an auto-forfeit.</li>
						...
						<ul>
						<li>There are only a limited number of entry nodes.</li>
						<li>If a new team wants to enter and there are no empty entry nodes, it may challenge for any entry node.</li>
						<li>If there are empty entry nodes, a new squad will get assigned to an empty entry node.  We will favor placing them in an area to maximize battle options.</li>  
						<li>You can only hold one entry node.  You cannot challenge for an entry node unless you are not currently on the map.</li>
						</ul>
				
						<b>Lag Bombing, Exploits, and Cheating</b>
						<ul>
							<li>There is currently an exploit known as "Lag-Bombing".  Until we patch this, using this exploit is considered illegal and will be dealt with at the Administrator's discretion.</li>
							<li>Additionally, any attempt to use exploits, cheat, hack, or alter the intended SquadWar experience or web site will be considered illegal and will be dealt with at the Adminstrator's discretion.</li>
						</ul>
				</div>
